...
{
    [Authorize(Users = "bacteriology")]
    public class BacteriologyController : Controller
    {
        private DataManager _dataManager;

        public BacteriologyController(DataManager dataManager)
        {
        ...
        {
            var directions = _dataManager.Directions.GetNotCompletedDirectionsByDepartment("бактериология");
        ...
        {
            var results = _dataManager.Results.GetResultsByDepartment("бактериология");
