...
{
    [Authorize(Users = "toxicology")]
    public class ToxicologyController : Controller
    {
        private DataManager _dataManager;

        public ToxicologyController(DataManager dataManager)
        {
        ...
        {
            var results = _dataManager.Results.GetResultsByDepartment("токсикология");
